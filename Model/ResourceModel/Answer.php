...
use Ecomteck\ProductQuestions\Model\Status as AnswerStatus;
...
class Answer extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
     ...
     *
     * @var \Ecomteck\ProductQuestions\Model\AdminUser
     */
     ...
     * Question
     *
     * @var \Ecomteck\ProductQuestions\Model\Question
     */
    protected $question;
     ...
     * @param \Ecomteck\ProductQuestions\Model\AdminUser $authSession
     * @param \Ecomteck\ProductQuestions\Model\UserType $userType
     * @param \Magento\Customer\Model\Customer $customerModel
     * @param \Ecomteck\ProductQuestions\Model\Question $question
     */
    public function __construct(
        \Magento\Framework\Model\ResourceModel\Db\Context $context,
        \Ecomteck\ProductQuestions\Model\ValidationRules $validationRules,
        \Magento\Framework\Escaper $escaper,
        \Ecomteck\ProductQuestions\Model\AdminUser $authSession,
        \Ecomteck\ProductQuestions\Model\UserType $userType,
        \Magento\Customer\Model\Customer $customerModel,
        \Ecomteck\ProductQuestions\Model\Question $question
    ) {
    ...
    {
        $this->_init('ecomteck_product_answers', 'answer_id');
    }
    ...
    public function updateTheQuestion(AbstractModel $object, $type = 'total_answers')
    {
        ...
        foreach ($count as $value) {
            $adapter->update(
                $this->getTable('ecomteck_product_questions'),
                [$type => $value['count']],
     ...
     * @return string
     */
    public function getAdminEmail($default = 'ecomteck_ecommerce@magento.com')
    {
     ...
     * @return string
     */
    public function getAdminName($default = 'ecomteck')
    {
